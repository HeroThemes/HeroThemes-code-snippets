...
adding ht_kb_settings option debug example

= 0.34 =
adding ht_formatting_blocks_enabled example to disable the formatting blocks module

= 0.33 =
adding ht_ai_search_text_response_after filter example
...
= 0.30 =
adding exclude article from kb search example

= 0.29 =
adding help assistant display control example
